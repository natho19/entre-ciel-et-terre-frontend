jQuery(document).ready(function ($) {
    ...
    $('#mobile_menu_slide .menu-item-has-children > a').append(
        $('<span/>', { class: 'arrow_down' }).html(
    ...
    if ($('.sb-toggle-left').length) {
        ...
        $('#menu-main-menu .menu-item-has-children > a').append(
            $('<span/>', { class: 'arrow_down' }).html('<i class="jli-down-chevron-1"></i>')
        );
    }
